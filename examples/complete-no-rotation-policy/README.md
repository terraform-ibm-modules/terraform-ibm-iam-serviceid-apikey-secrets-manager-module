...
| <a name="module_iam_secrets_engine"></a> [iam\_secrets\_engine](#module\_iam\_secrets\_engine) | git::https://github.ibm.com/GoldenEye/secrets-manager-iam-engine-module.git | 2.1.3 |
